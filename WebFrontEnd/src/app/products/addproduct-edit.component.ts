...
@Component({ templateUrl: 'addproduct-edit.component.html' })
export class AddEditProductComponent implements OnInit {
    ...
    private createProduct() {
        this.productsService.register(this.form.value)
            .pipe(first())
            .subscribe({
                next: () => {
    ...
    private updateProduct() {
        this.productsService.update(this.id, this.form.value)
            ...
            .subscribe({
                next: () => {
                    this.alertService.success('Product successful', { keepAfterRouteChange: true });
                    this.router.navigate(['../../'], { relativeTo: this.route });
                },
                error: error => {
                    this.alertService.error(error);
